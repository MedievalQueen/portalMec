 		...
 		<div class="well sidebar-nav">
			<div class="col-sm-6">
			  ...
			  <option value="#">...</option>
             		...
             		<br/><br/>Ano: <br/>1º<input type="checkbox">4º<input type="checkbox"><br/>2º<input type="checkbox">5º<input type="checkbox"><br/>3º<input type="checkbox">6º<input type="checkbox">
            		<br/><br/> 
			<select>
